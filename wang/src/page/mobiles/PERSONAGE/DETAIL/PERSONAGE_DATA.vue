        ...
        <div class="personContent">
            <el-form :model="formItem" class="personContent_form" label-width="80px">
                ...
                <el-form-item class="star" :label="$t('userInfo.address')">
                    ...
                    <el-input
                        class="widthAll_Fixed textareaBox"
                        type="textarea"
                ...
                <el-form-item :label="$t('userInfo.social')">
                    <el-input class="widthAll_Fixed" v-model="formItem.socialUrl"
                              :placeholder="$t('userInfo.inputSocial')"/>
                </el-form-item>
                <el-form-item>
...
<style>
    /*输入框背景*/
    .mobilePersonBox .personContent_form .el-form-item {
        padding: 15px 0;
        margin-bottom: 10px;
        background-color: rgba(0, 0, 0, 0.2);
    }

    .mobilePersonBox .personContent_form .el-form-item__label,
    .mobilePersonBox .personContent_form .el-radio__label {
        color: #fff;
    }

    .mobilePersonBox .personContent_form .star .el-form-item__label::before {
        content: '*';
        margin-right: 5px;
        color: red;
    }

    .mobilePersonBox .personContent_form .el-input .el-input__inner,
    .mobilePersonBox .textareaBox .el-textarea__inner {
    ...
    .mobilePersonBox .personContent_form .el-select .el-input.is-focus .el-input__inner {
        border-color: #6d757b;
    }
</style>
