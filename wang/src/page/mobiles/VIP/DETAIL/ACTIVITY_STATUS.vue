    ...
    <div class="vipStatusMobile_Box">
        <div class="vipStatusMobile tc">
            <div v-if="formItem.isSuccess === true">
                <img class="statusIcon" src="../../../../assets/img/vipPhoto/success.png"/>
            ...
            <div class="mainBtn">
                ...
                <el-button v-if="formItem.isSuccess === true" size="small" type="default" class="homeBtn"
                           @click="record">
                    {{$t('order.see')}}
                </el-button>
                <el-button v-if="formItem.isSuccess === false" size="small" class="homeBtn" type="default"
                           @click="continueBtn">{{$t('order.continue')}}
                </el-button>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 调用生成订单明细接口
            getSaveOrderItem(orderId, payWay) {
                let _t = this;
                _t.$api.post('orderIterm/saveOrderIterm', {
