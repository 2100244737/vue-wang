<template>
    ...
    <div class="mobileContentBox">
        <el-tabs class="mobileUserTitle" v-model="formItem.activeName">
            <!--vip活动公告-->
            <el-tab-pane :label="$t('vipLimit.activity')" name="first">
                ...
                <div class="newsTheme">
                    ...
                    <div v-else class="ActivityList" v-for="(item,index) in activeData" :key="index">
                        <div class="imgLeft message_img cursorPointer"
...
<style>
    .mobileUserTitle .el-tabs__nav-wrap::after {
        height: 0;
    }

    .mobileUserTitle .el-tabs__item {
    ...
    .mobileUserTitle .el-tabs__item.is-active {
        color: #fff !important;
    }

    .mobileUserTitle .el-tabs__active-bar {
