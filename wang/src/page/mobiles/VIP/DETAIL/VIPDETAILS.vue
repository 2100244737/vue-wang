<template>
    <div class="mobileVipDetail">
        <!--头部标题-->
        <div class="mobileVipShop">
            <!--图片区域-->
            ...
            <div class="shopTextBox">
                ...
                <div class="showPrice displayFlexRow_In marginTop15">
                    <div class="priceLabel">{{$t('ticketGrabbing.parValue')}}：</div>
                    <div class="flex_1">
                ...
                <div class="showPrice marginTop15">
                    <div class="priceLabel">{{$t('ticketGrabbing.num')}}：</div>
                    <div class="flex_1">
                        <el-input-number
                            class="showNum_num"
                ...
                <div class="showTotal marginTop10">
                    <div class="priceLabel">{{$t('ticketGrabbing.total')}}</div>
                    <div class="total marginLeft20">
                        <b>{{formItem.total}}</b>
                        <span>HKD</span>
                    </div>
                </div>
                <div class="goBuyBtn marginTop10">
                    <el-button
                        type="default"
                        size="small"
        ...
        <!--底部文字介绍-->
        <div class="showIntroduce showMobileIntroduce">
    ...
    export default {
            ...
            goBuy() {
                ...
                if (_t.formItem.vipId !== "") {
                    ...
                    _t.$api.post("order/saveOrder", {
                        ...
                        ticketCount: _t.formItem.number, // 购买张数
                        inventoryId: _t.formItem.checkId, // 选中票id
                    }, function (res) {
        ...
        created() {
            ...
            if (jump === false) {
                ...
                if (_t.formItem.vipId !== null && _t.formItem.vipId !== '') {
                    _t.getData();
                    _t.getPrice();
                    _t.refreshPage();
                }
...
<style>
    ...
    .ticketNum .el-radio-button__inner {
        padding: 5px 10px;
        text-align: center;
        line-height: 20px;
    ...
    .ticketNum .el-radio-button__orig-radio:checked + .el-radio-button__inner,
    .ticketNum.el-radio-button.is-focus .el-radio-button__inner {
        outline: none;
    ...
    .ticketNum .el-radio-button:focus:not(.is-focus):not(:active):not(.is-disabled) {
        box-shadow: none;
    }
</style>
