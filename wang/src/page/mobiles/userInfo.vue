<template>
    <div class="mobilePerson_infoBox">
        <div class="personContent">
            <el-form :model="formItem" class="personContent_form" label-width="80px">
                <el-form-item class="star" :label="$t('userInfo.account')">
                    <el-input disabled class="widthAll_Fixed" v-model="formItem.account"/>
                ...
                <el-form-item :label="$t('userInfo.sex')">
                    <el-select class="widthAll_Fixed" v-model="formItem.sex">
                ...
                <el-form-item class="star" :label="$t('userInfo.address')">
                    ...
                    <div v-if="formItem.sync">
                        <el-select
                            class="widthAll_Fixed marginBottom15"
                        ...
                        <el-select class="widthAll_Fixed marginBottom15" v-model="formItem.city"
                ...
                <el-form-item :label="$t('userInfo.social')">
                    <el-input v-model="formItem.socialUrl" :placeholder="$t('userInfo.inputSocial')"/>
                </el-form-item>
                <el-form-item>
...
<script>
    ...
    export default {
            ...
            clickBtn() {
                ...
                if (_t.errorTip.accountFlag === false
                    ...
                    _t.$api.post("user/userUpdateUserInfo", {
                        ...
                        switch (res.status) {
                            case 200:
                                _t.$confirm(_t.$t("userInfo.reLogin"), _t.$t("public.warmPrompt"), {
        ...
        created() {
            let _t = this;
            let jump = _t.$jump.isToJump(_t.$route.name, 'USER_INFO', 'M_USER_INFO');
            if (jump === false) {
                // 获取用户信息
                _t.getUserInfo();
            }
            _t.$bus.on("getUserInfo", val => {
                if (val) {
                    _t.getUserInfo();
                }
            });
...
<style>
    /*输入框背景*/
    .mobilePerson_infoBox .personContent_form .el-form-item {
        padding: 15px 15px 15px 0;
        margin-bottom: 10px;
        background-color: rgba(0, 0, 0, 0.2);
    }

    .mobilePerson_infoBox .personContent_form .el-form-item__label,
    .mobilePerson_infoBox .personContent_form .el-radio__label {
        color: #fff;
    }

    .mobilePerson_infoBox .personContent_form .star .el-form-item__label::before {
        content: '*';
        margin-right: 5px;
        color: red;
    }

    .mobilePerson_infoBox .personContent_form .el-input .el-input__inner,
    .mobilePerson_infoBox .textareaBox .el-textarea__inner {
    ...
    .mobilePerson_infoBox .personContent_form .el-select .el-input.is-focus .el-input__inner {
        border-color: #6d757b;
    }
</style>
