    ...
    <div class="positionRelative">
            ...
            <div class="navBar_bg">
                <div class="message_img bannerBox">
                    <img v-if="carouselMapImg === ''" class="widthAll"
                         src="../../../assets/img/header/defaultBanner.png"
                         alt="banner">
            ...
            <div class="tc bgContent_center">
                ...
                <div class="vipBox">
                    <div class="vipText" v-if="formItem.isVip">
                        ...
                        <span class="marginLR15">|</span>
                        <span>{{formItem.startTime}}</span>
                        <span>-</span>
                        <span>{{formItem.endTime}}</span>
                    </div>
                    <el-button v-else class="vipBtn" type="default" plain @click="joinVip">
        ...
        <div class="bgContent">
            <ul id="PERSONAGE" class="secondaryNavigation">
                <!--
                <li id="MEMBER" @click="handleJump('MEMBER')">{{$t('aboutSettings.vipStatus')}}</li>
                <li id="PERSONAGE_DATA" @click="handleJump('PERSONAGE_DATA')">{{$t('aboutSettings.personText')}}</li>
                <li id="MY_ACTIVITY" @click="handleJump('MY_ACTIVITY')">{{$t('aboutSettings.activity')}}</li>
                <li id="MY_ORDER" @click="handleJump('MY_ORDER')">{{$t('aboutSettings.order')}}</li>
                <li id="SUBSCRIPTION" @click="handleJump('SUBSCRIPTION')">{{$t('aboutSettings.subscribe')}}</li>
                <li id="FEEDBACK" @click="handleJump('FEEDBACK')">{{$t('aboutSettings.feedback')}}</li>
                -->
                <li id="MEMBER" @click="handleJump('MEMBER')">{{formMenu.status}}</li>
                <li id="PERSONAGE_DATA" @click="handleJump('PERSONAGE_DATA')">{{formMenu.personal}}</li>
                <!--
                <li id="MY_ACTIVITY" @click="handleJump('MY_ACTIVITY')">{{formMenu.myActivity}}</li>
                -->
                <li id="MY_ORDER" @click="handleJump('MY_ORDER')">{{formMenu.myOrder}}</li>
                <!--<li id="SUBSCRIPTION" @click="handleJump('SUBSCRIPTION')">{{formMenu.reserve}}</li>-->
                <li id="FEEDBACK" @click="handleJump('FEEDBACK')">{{formMenu.feedback}}</li>
            </ul>
            <router-view/>
        </div>
    </div>
...
<style>
    .vipBtn.el-button.is-plain:focus,
    .vipBtn.el-button.is-plain:hover {
    ...
    .bgContent_center .photo_box .el-upload {
        position: absolute;
        top: 50%;
        left: 50%;
        transform: translate(-50%, -50%);
