        ...
        <div class="personContent">
            <el-form :model="formItem" class="personContent_form" label-width="100px">
                ...
                <el-form-item :label="$t('userInfo.sex')">
                    <el-select class="width200" v-model="formItem.sex">
                ...
                <el-form-item class="star" :label="$t('userInfo.address')">
                    ...
                    <div v-if="formItem.sync">
                        ...
                        <el-select class="width200 marginBottom15 marginLeft10" v-model="formItem.city"
...
<style>
    /*输入框背景*/
    .person_infoBox .personContent_form .el-form-item {
        padding: 15px 0;
        margin-bottom: 10px;
        background-color: rgba(0, 0, 0, 0.2);
    }

    .person_infoBox .personContent_form .el-input .el-input__inner,
    .person_infoBox .textareaBox .el-textarea__inner {
        background-color: transparent;
        background-image: url("../../assets/img/common/mask_bg.png") repeat;
        color: #fff;
        border-color: #6d757b;
    }
    ...
    .person_infoBox .personContent_form .el-form-item__label,
    .person_infoBox .personContent_form .el-radio__label {
        color: #fff;
    }

    .person_infoBox .personContent_form .star .el-form-item__label::before {
        content: "*";
        margin-right: 5px;
        color: red;
    }
