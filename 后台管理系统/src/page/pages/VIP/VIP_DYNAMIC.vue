                                ...
                                <div class="dis_content">
                                    ...
                                    <div class="flex_1">
                                        <div class="fontSize14">
                                            ...
                                            <el-button
                                                type="text"
                                                class="redColor marginLR10 reviewBox_vip_delete"
                                                @click="deleteReview(review,item)">删除评论
                                            </el-button>
                                        </div>
                                        <div class="font13 marginTop5 grayColor">{{review.replyTime}}</div>
                                    </div>
                                </div>
                                <div class="dis_content_base">
                                    <div v-if="review.sonList.length !== 0 && review.sonList !== null">
                                        <div class="sonList marginTop10" v-for="(data,k) in review.sonList" :key="k">
                                    ...
                                    <div v-else class="reviewBox_vip">
